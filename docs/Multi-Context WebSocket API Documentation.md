...
subtitle: >-
  ...
  API for dynamic and responsive interactions.
---
...
<Info>Multi-context WebSockets are not available for the `eleven_v3` model.</Info>
...
This API extends our [standard TTS WebSocket functionality](/docs/developers/websockets) by introducing the concept of "contexts." Each context operates as an independent audio generation stream within a single WebSocket connection. This allows you to:
...
- Familiarity with WebSocket communication. We recommend reading our [guide on standard WebSocket streaming](/docs/developers/websockets) for foundational concepts.
